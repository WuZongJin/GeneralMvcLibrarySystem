...
namespace General.Mvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<IUpdateLibrarySeatStateService,UpdateLibrarySeatService>();
            //
            EnginContext.Initialize(new GeneralEngine(services.BuildServiceProvider()));
            //EnginContext.Current.Resolve<Framework.Infrastructure.IUpdateLibrarySeatStateService>();
            ;
