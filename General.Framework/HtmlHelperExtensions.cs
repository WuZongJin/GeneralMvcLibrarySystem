...
namespace General.Framework
{
    public static class HtmlHelperExtensions
    {
        ...
        public static ISysUserService GetSysUserService(this IHtmlHelper helper)
        {
            return Core.EnginContext.Current.Resolve<ISysUserService>();
        }

        public static ILibrarySeatService GetLibrarySeatService(this IHtmlHelper helper)
        {
            return Core.EnginContext.Current.Resolve<ILibrarySeatService>();
        }
