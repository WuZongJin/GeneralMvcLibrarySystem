...
namespace General.Services.SysUser
{
    public class SysUserService : ISysUserService
    {
        ...
        {
            _sysUserRepository.update(model);
        }
        ...
        {
            return _sysUserRepository.Table.Any(o => o.Email == email && !o.IsDeleted);
        }

        public bool existMobilePhone(string mobilePhone)
        {
            return _sysUserRepository.Table.Any(o => o.MobilePhone == mobilePhone && !o.IsDeleted);
        }

        public void scheduleLock(Guid id, bool ulock, Guid modifer)
        {
            var user = _sysUserRepository.getById(id);
            if (ulock)
            {
